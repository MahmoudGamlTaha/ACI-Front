    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
                ...
                <MainPoster icon={<div style={{color:'var(--text-purple-600)',background:'var(--bg-purple-100)'}} className="p-3 rounded-full "><Users /></div>} title={t('loggedInHome.compeletedShipments')} num={9} />
            </div>
        </div>
    );
}